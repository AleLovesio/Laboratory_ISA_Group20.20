...
saveDesign riscv
getFillerMode -quiet
addFiller -cell FILLCELL_X2 FILLCELL_X1 FILLCELL_X16 FILLCELL_X32 FILLCELL_X4 FILLCELL_X8 -prefix FILLER
...
timeDesign -postRoute -pathReports -slackReports -numPaths 50 -prefix riscv_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
...
saveNetlist riscv_postroute.v
all_hold_analysis_views 
all_setup_analysis_views 
write_sdf  -ideal_clock_network riscv_postroute.sdf
saveDesign riscv_postroute_opt
